...
export const metadata: Metadata = buildMetadata({
  title: "Contact — Start an AI, Web or App Project | Brilyx",
  description:
...
export default function ContactPage() {
  return (
    <>
      ...
      <section className="mx-auto max-w-6xl px-4 pt-12 pb-24 sm:px-6 sm:pt-20 lg:px-8">
        <Reveal>
          <SectionHeading
            as="h1"
            eyebrow="Contact"
        ...
        <div className="mt-12 grid gap-12 lg:grid-cols-[1.1fr_0.9fr]">
          <Reveal className="flex flex-col items-start gap-4 rounded-xl border border-border bg-card p-8">
            ...
            <h2 className="text-xl font-semibold tracking-tight text-foreground">WhatsApp</h2>
            <p className="text-sm leading-relaxed text-muted-foreground">
              Fastest way to reach us. Share a short brief and we will come back with next steps.
            </p>
